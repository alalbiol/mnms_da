...
def compute_metrics_on_directories(dir_gt, dir_pred, remove_preds):
    ...
    for indx, (p_gt, p_pred) in enumerate(zip(lst_gt, lst_pred)):
        ...
        res_n, res_zsn = metrics_slice(gt.astype(int), pred.astype(int), zooms)
    ...
    print(df.groupby(['Vendor'])[dice_cols].mean())
...
if __name__ == "__main__":
    """
      Dir Usage: python tools/metrics_mnms.py --GT_IMG "data/MMs/Testing/" --PRED_IMG "my_preds/"
    """
