...
output_dir="results/$dataset/SEGMENTATIONVIAGENERATOR_${gen_net}_${gen_upsample}/$model/$optimizer"
output_dir="$output_dir/${scheduler}_lr${lr}/${criterion}_weights${weights_criterion}"
